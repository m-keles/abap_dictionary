*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMK_VIEW_PARTNER
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMK_VIEW_PARTNER    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMK_VIEW_PARTNER'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMK_VIEW_PARTNER_EXTRACT
TOTAL = ZMK_VIEW_PARTNER_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMK_VIEW_PARTNER'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMK_VIEW_PARTNER-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMK_VIEW_PARTNER_EXTRACT
TOTAL = ZMK_VIEW_PARTNER_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMK_VIEW_PARTNER-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMK_VIEW_PARTNER'
...
TOTAL = ZMK_VIEW_PARTNER_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMK_VIEW_PARTNER-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMK_VIEW_PARTNER-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMK_VIEW_PARTNER'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMK_VIEW_PARTNER-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMK_VIEW_PARTNER_EXTRACT
TOTAL = ZMK_VIEW_PARTNER_TOTAL
